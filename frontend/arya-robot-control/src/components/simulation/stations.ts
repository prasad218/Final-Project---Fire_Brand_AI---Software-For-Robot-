...
//
// "reception" is deliberately placed just in FRONT of the reception desk
// (not on top of it) — the desk itself is a solid obstacle in
// worldBounds.ts, so a target point inside its footprint is physically
// unreachable and caused the robot to jitter/stall trying to approach it.
export const STATIONS: StationDefinition[] = [
  { id: "reception", name: "Reception", position: { x: 2.3, y: 0, z: 3.4 }, color: "#38d3ff" },
